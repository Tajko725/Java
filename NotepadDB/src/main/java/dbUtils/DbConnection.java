...
public class DbConnection {
    ...
    private static final String SQLITECONN = "jdbc:sqlite:"+ DBFILEPATH; // jdbc:sqlite:sciezkaDoBazyPrawdopodobnie (folder musi istnieć, jak nie to exception)  np. jdbc:sqlite:C:/sqlite/db/bazaDanych.sqlite
